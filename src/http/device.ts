...
export class Device extends TypedEmitter<DeviceEvents> {
  ...
  public update(device: DeviceListResponse): void {
    ...
    for (const property of Object.values(metadata)) {
      if (
        this.rawDevice[property.key] !== undefined &&
        ...
        if (
          ...
          this.updateProperty(
            property.name,
            this.convertRawPropertyValue(
              property,
              getImagePath(this.rawDevice[property.key]),
            ),
          );
        } else {
          this.updateProperty(
            ...
            this.convertRawPropertyValue(
              property,
              this.rawDevice[property.key] as string,
            ),
          );
        }
      } else if (
    ...
    rootHTTPLogger.debug("Update device cloud properties", {
    ...
    if (
      ...
      try {
        this.handlePropertyChange(
          this.getPropertyMetadata(name, true),
          oldValue,
        ...
        if (error instanceof InvalidPropertyError) {
          rootHTTPLogger.error(
            `Device update property - Invalid Property error`,
            {
  ...
  public updateRawProperties(values: RawValues): void {
    Object.keys(values).forEach((paramtype) => {
      ...
      this.updateRawProperty(
        param_type,
        values[param_type].value,
        values[param_type].source,
      );
    });
  }
  ...
  protected handlePropertyChange(
    ...
    try {
      if (
        (metadata.key === ParamType.DETECT_MOTION_SENSITIVE ||
          metadata.key === ParamType.DETECT_MODE) &&
        ...
        const rawSensitivity = this.getRawProperty(
          ParamType.DETECT_MOTION_SENSITIVE,
        );
        ...
        this.updateProperty(
          ...
          calculateWifiSignalLevel(this, newValue as number),
        );
      } else if (
        ...
        this.updateProperty(
          ...
          calculateCellularSignalLevel(newValue as number),
        );
      }
    } catch (err) {
      const error = ensureError(err);
  ...
  public updateRawProperty(
    type: number,
    value: string,
    source: SourceType,
  ): boolean {
    const parsedValue = ParameterHelper.readValue(
      this.getStationSerial(),
      type,
      value,
      rootHTTPLogger,
    );
          ...
          try {
            ...
            if (error instanceof PropertyNotSupportedError) {
              rootHTTPLogger.debug(
                "Device update raw property - Property not supported error",
                {
                  error: getError(error),
                  deviceSN: this.getSerial(),
                  type: type,
              ...
              rootHTTPLogger.error(
                "Device update raw property - Property error",
                {
                  error: getError(error),
                  deviceSN: this.getSerial(),
                  type: type,
  ...
  protected convertRawPropertyValue(
    property: PropertyMetadataAny,
    value: string,
  ): PropertyValue {
    try {
      if (
        ...
        property.key === CommandType.CMD_BAT_DOORBELL_SET_NOTIFICATION_MODE
      ) {
        switch (property.name) {
          case PropertyName.DeviceNotificationRing: {
            ...
            try {
              return value !== undefined
                ? Number.parseInt((value as any).notification_ring_onoff) === 1
              ...
              return booleanProperty.default !== undefined
                ? booleanProperty.default
                : false;
            }
          }
          case PropertyName.DeviceNotificationMotion: {
            ...
            try {
              return value !== undefined
                ? Number.parseInt((value as any).notification_motion_onoff) ===
                    1
                : booleanProperty.default !== undefined
                  ? booleanProperty.default
                  : false;
          ...
          case PropertyName.DeviceNotificationType: {
            ...
            try {
              return value !== undefined
                ? Number.parseInt((value as any).notification_style)
        ...
        try {
          switch (property.name) {
            case PropertyName.DeviceNotificationRing:
              return value !== undefined
                ? Number.parseInt(value as any) === 3 ||
                    Number.parseInt(value as any) === 1
                : false;
            case PropertyName.DeviceNotificationMotion:
              return value !== undefined
                ? Number.parseInt(value as any) === 3 ||
                    Number.parseInt(value as any) === 2
                : false;
          }
        } catch (err) {
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - DOORBELL_NOTIFICATION_OPEN Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          if (
            this.getDeviceType() === DeviceType.CAMERA ||
            this.getDeviceType() === DeviceType.CAMERA_E
          ) {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_SET_PIRSENSITIVITY Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          switch (property.name) {
            case PropertyName.DeviceMotionDetectionSensitivityMode:
              return value !== undefined && (value as any).model !== undefined
                ? ((value as any).model as number)
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityStandard:
              return value !== undefined && (value as any).model === 0
                ? getDistances((value as any).block_list)[0]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedA:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[0]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedB:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[1]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedC:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[2]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedD:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[3]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedE:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[4]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedF:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[5]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedG:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[6]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
            ...
            case PropertyName.DeviceMotionDetectionSensitivityAdvancedH:
              return value !== undefined && (value as any).model === 1
                ? getDistances((value as any).block_list)[7]
                : numericProperty.default !== undefined
                  ? numericProperty.default
                  : numericProperty.min !== undefined
                    ? numericProperty.min
        ...
        property.key === CommandType.CMD_DOORBELL_DUAL_RADAR_WD_AUTO_RESPONSE
      ) {
        switch (property.name) {
          case PropertyName.DeviceLoiteringCustomResponseTimeFrom: {
            ...
            try {
              ...
              return stringProperty.default !== undefined
                ? stringProperty.default
                : "";
            }
          }
          ...
          case PropertyName.DeviceLoiteringCustomResponsePhoneNotification: {
            const booleanProperty = property as PropertyMetadataBoolean;
            try {
              return (value as any)?.setting[0]?.push_notify === 1
                ? true
                : booleanProperty.default !== undefined
                  ? booleanProperty.default
                  : false;
          ...
          case PropertyName.DeviceLoiteringCustomResponseHomeBaseNotification: {
            const booleanProperty = property as PropertyMetadataBoolean;
            try {
              return (value as any)?.setting[0]?.homebase_alert === 1
                ? true
                : booleanProperty.default !== undefined
                  ? booleanProperty.default
                  : false;
          ...
          case PropertyName.DeviceLoiteringCustomResponseAutoVoiceResponse: {
            const booleanProperty = property as PropertyMetadataBoolean;
            try {
              return (value as any)?.setting[0]?.auto_voice_resp === 1
                ? true
                : booleanProperty.default !== undefined
                  ? booleanProperty.default
                  : false;
        ...
        property.key === CommandType.CMD_DOORBELL_DUAL_DELIVERY_GUARD_SWITCH
      ) {
        const booleanProperty = property as PropertyMetadataBoolean;
        try {
          return value !== undefined &&
            (value as any).ai_bottom_switch !== undefined
            ? (value as any).ai_bottom_switch === 1024
            : booleanProperty.default !== undefined
              ? booleanProperty.default
              : false;
        } catch (err) {
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_DOORBELL_DUAL_DELIVERY_GUARD_SWITCH Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        property.key === CommandType.CMD_DOORBELL_DUAL_PACKAGE_STRAND_TIME
      ) {
        const stringProperty = property as PropertyMetadataString;
        try {
          return (value as any)?.start_h !== undefined &&
            (value as any)?.start_m !== undefined
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_DOORBELL_DUAL_PACKAGE_STRAND_TIME Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        property.key === CommandType.CMD_DOORBELL_DUAL_RING_AUTO_RESPONSE
      ) {
        switch (property.name) {
        ...
        property.key === CommandType.CMD_DOORBELL_DUAL_PACKAGE_GUARD_TIME
      ) {
        switch (property.name) {
          ...
          case PropertyName.DeviceDeliveryGuardPackageGuardingActivatedTimeTo: {
            const stringProperty = property as PropertyMetadataString;
            try {
              return (value as any)?.end_h !== undefined &&
                (value as any)?.end_m !== undefined
        ...
        property.key === CommandType.CMD_DOORBELL_DUAL_RADAR_WD_DISTANCE
      ) {
        const numericProperty = property as PropertyMetadataNumeric;
        try {
          return value !== undefined &&
            (value as any).radar_wd_distance !== undefined
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_DOORBELL_DUAL_RADAR_WD_DISTANCE Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          return value !== undefined &&
            (value as any).radar_wd_time !== undefined
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_DOORBELL_DUAL_RADAR_WD_TIME Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        property.key === CommandType.CMD_DOORBELL_DUAL_PACKAGE_GUARD_VOICE
      ) {
        const numericProperty = property as PropertyMetadataNumeric;
        try {
          return value !== undefined &&
            (value as any).auto_voice_id !== undefined
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_DOORBELL_DUAL_PACKAGE_GUARD_VOICE Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        property.key === CommandType.CMD_MOTION_SET_LEAVING_REACTIONS
      ) {
        switch (property.name) {
        ...
        switch (property.name) {
          case PropertyName.DeviceSnooze: {
            ...
            try {
              ...
              const error = ensureError(err);
              rootHTTPLogger.error(
                "Device convert raw property - CMD_SET_SNOOZE_MODE DeviceSnooze Error",
                {
                  error: getError(error),
                  deviceSN: this.getSerial(),
                  property: property,
          ...
          case PropertyName.DeviceSnoozeTime: {
            ...
            try {
              ...
              const error = ensureError(err);
              rootHTTPLogger.error(
                "Device convert raw property - CMD_SET_SNOOZE_MODE DeviceSnoozeTime Error",
                {
                  error: getError(error),
                  deviceSN: this.getSerial(),
                  property: property,
          ...
          case PropertyName.DeviceSnoozeStartTime: {
            ...
            try {
              return value !== undefined &&
                (value as any).startTime !== undefined
          ...
          case PropertyName.DeviceSnoozeHomebase: {
            ...
            try {
              return value !== undefined &&
                (value as any).homebase_onoff !== undefined
              ...
              const error = ensureError(err);
              rootHTTPLogger.error(
                "Device convert raw property - CMD_SET_SNOOZE_MODE DeviceSnoozeHomebase Error",
                {
                  error: getError(error),
                  deviceSN: this.getSerial(),
                  property: property,
          ...
          case PropertyName.DeviceSnoozeMotion: {
            ...
            try {
              return value !== undefined &&
                (value as any).motion_notify_onoff !== undefined
              ...
              const error = ensureError(err);
              rootHTTPLogger.error(
                "Device convert raw property - CMD_SET_SNOOZE_MODE DeviceSnoozeMotion Error",
                {
                  error: getError(error),
                  deviceSN: this.getSerial(),
                  property: property,
          ...
          case PropertyName.DeviceSnoozeChime: {
            ...
            try {
              return value !== undefined &&
                (value as any).chime_onoff !== undefined
              ...
              const error = ensureError(err);
              rootHTTPLogger.error(
                "Device convert raw property - CMD_SET_SNOOZE_MODE DeviceSnoozeChime Error",
                {
                  error: getError(error),
                  deviceSN: this.getSerial(),
                  property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - HB3 motion detection type Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - T8170 motion detection type Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - T8416 motion detection type Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - SoloCamera motion detection type Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - IndoorPanAndTiltCameraS350 notification Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - FloodLightT8425 notification Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        const numericProperty = property as PropertyMetadataNumeric;
        const quality: VideoStreamingRecordingQuality =
          value as unknown as VideoStreamingRecordingQuality;
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_BAT_DOORBELL_VIDEO_QUALITY2 Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        property.key === CommandType.CMD_BAT_DOORBELL_RECORD_QUALITY2
      ) {
        const numericProperty = property as PropertyMetadataNumeric;
        const quality: VideoStreamingRecordingQuality =
          value as unknown as VideoStreamingRecordingQuality;
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.error(
            "Device convert raw property - CMD_BAT_DOORBELL_RECORD_QUALITY2 Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        property.key === CommandType.CMD_DEV_RECORD_AUTOSTOP &&
        this.isCameraProfessional247()
      ) {
        return value !== undefined ? (value === "0" ? true : false) : false;
      } else if (
        property.key === CommandType.CMD_FLOODLIGHT_SET_DETECTION_RANGE_T8425
      ) {
        const currentValue =
          value as unknown as FloodlightDetectionRangeT8425Property;
        switch (property.name) {
          case PropertyName.DeviceMotionDetectionRange: {
            const numericProperty = property as PropertyMetadataNumeric;
            return currentValue !== undefined &&
              currentValue.cur_mode !== undefined
          ...
          case PropertyName.DeviceMotionDetectionRangeStandardSensitivity: {
            ...
            return currentValue !== undefined &&
              ...
              currentValue.mode0.find((element) => element.id === 1) !==
                undefined
          ...
          case PropertyName.DeviceMotionDetectionRangeAdvancedLeftSensitivity: {
            ...
            return currentValue !== undefined &&
              ...
              currentValue.mode1.find((element) => element.id === 1) !==
                undefined
          ...
          case PropertyName.DeviceMotionDetectionRangeAdvancedRightSensitivity: {
            ...
            return currentValue !== undefined &&
              ...
              Array.isArray(currentValue.mode1) &&
              currentValue.mode1.length > 0 &&
              currentValue.mode1.find((element) => element.id === 2) !==
                undefined
          ...
          case PropertyName.DeviceMotionDetectionTestMode: {
            const booleanProperty = property as PropertyMetadataBoolean;
            return currentValue !== undefined &&
              currentValue.test_mode !== undefined
        ...
        property.key === CommandType.CMD_SET_LIGHT_CTRL_BRIGHT_SCH_T8425
      ) {
        const currentValue =
          value as unknown as FloodlightLightSettingsBrightnessScheduleT8425Property;
        const numericProperty = property as PropertyMetadataNumeric;
        return currentValue !== undefined &&
          currentValue.brightness !== undefined
        ...
        property.key === CommandType.CMD_SET_LIGHT_CTRL_BRIGHT_PIR_T8425
      ) {
        const currentValue =
          value as unknown as FloodlightLightSettingsMotionT8425Property;
        switch (property.name) {
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.warn(
            "Device convert raw property - SUB1G_REP_UNPLUG_POWER_LINE Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.warn(
            "Device convert raw property - PropertyMetadataNumeric Convert Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
        ...
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.warn(
            "Device convert raw property - PropertyMetadataBoolean Convert Error",
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              property: property,
  ...
  public getPropertyMetadata(
    ...
    throw new InvalidPropertyError("Property name is not valid", {
      context: { name: name },
    });
  }
  ...
  public getPropertiesMetadata(hidden = false): IndexedProperty {
    ...
    if (this.isFloodLightT8420X()) {
      ...
      (metadata[PropertyName.Type] as PropertyMetadataNumeric).states![
        this.getDeviceType()
      ...
      newMetadata[PropertyName.DeviceAudioRecording] =
        DeviceAudioRecordingProperty;
      newMetadata[PropertyName.DeviceMotionDetectionSensitivity] =
        DeviceMotionDetectionSensitivityCamera2Property;
      newMetadata[PropertyName.DeviceVideoRecordingQuality] =
        DeviceVideoRecordingQualitySoloCamerasHB3Property;
      newMetadata[PropertyName.DeviceNotificationType] =
        DeviceNotificationTypeProperty;
      newMetadata[PropertyName.DeviceMotionDetection] =
        DeviceMotionDetectionProperty;
      ...
      newMetadata[PropertyName.DeviceMotionDetectionSensitivity] =
        DeviceMotionDetectionSensitivityBatteryDoorbellProperty;
      newMetadata[PropertyName.DeviceStatusLed] =
        DeviceStatusLedIndoorS350Property;
    ...
    if (
      ...
      newMetadata[PropertyName.DeviceMotionDetectionTypeHuman] =
        DeviceMotionHB3DetectionTypeHumanProperty;
      newMetadata[PropertyName.DeviceMotionDetectionTypeHumanRecognition] =
        DeviceMotionHB3DetectionTypeHumanRecognitionProperty;
      newMetadata[PropertyName.DeviceMotionDetectionTypePet] =
        DeviceMotionHB3DetectionTypePetProperty;
      newMetadata[PropertyName.DeviceMotionDetectionTypeVehicle] =
        DeviceMotionHB3DetectionTypeVehicleProperty;
      newMetadata[PropertyName.DeviceMotionDetectionTypeAllOtherMotions] =
        DeviceMotionHB3DetectionTypeAllOtherMotionsProperty;
      newMetadata[PropertyName.DevicePersonDetected] =
        DevicePersonDetectedProperty;
      newMetadata[PropertyName.DeviceMotionDetected] =
        DeviceMotionDetectedProperty;
      newMetadata[PropertyName.DevicePetDetected] = DevicePetDetectedProperty;
      newMetadata[PropertyName.DeviceSoundDetected] =
        DeviceSoundDetectedProperty;
      newMetadata[PropertyName.DeviceCryingDetected] =
        DeviceCryingDetectedProperty;
      newMetadata[PropertyName.DeviceIdentityPersonDetected] =
        DeviceIdentityPersonDetectedProperty;
      newMetadata[PropertyName.DeviceStrangerPersonDetected] =
        DeviceStrangerPersonDetectedProperty;
      newMetadata[PropertyName.DeviceVehicleDetected] =
        DeviceVehicleDetectedProperty;
      newMetadata[PropertyName.DeviceDogDetected] = DeviceDogDetectedProperty;
      newMetadata[PropertyName.DeviceDogLickDetected] =
        DeviceDogLickDetectedProperty;
      newMetadata[PropertyName.DeviceDogPoopDetected] =
        DeviceDogPoopDetectedProperty;
      newMetadata[PropertyName.DeviceDetectionStatisticsWorkingDays] =
        DeviceDetectionStatisticsWorkingDaysProperty;
  ...
  public setCustomPropertyValue(name: string, value: PropertyValue): void {
    ...
    if (
      ...
      metadata.key.startsWith("custom_")
    ) {
  ...
  static isSensor(type: number): boolean {
    if (type == DeviceType.SENSOR || type == DeviceType.MOTION_SENSOR)
      return true;
    return false;
  }
  ...
  static isSmartSafeBySn(sn: string): boolean {
    return (
      sn.startsWith("T7400") || sn.startsWith("T7401") || sn.startsWith("T7402")
    );
  }
  ...
  static isSmartTrack(type: number): boolean {
    if (
      type == DeviceType.SMART_TRACK_LINK ||
  ...
  public isFloodLightT8420X(): boolean {
    return Device.isFloodLightT8420X(
      this.rawDevice.device_type,
      this.rawDevice.device_sn,
    );
  }
  ...
  public isWiredDoorbellT8200X(): boolean {
    return Device.isWiredDoorbellT8200X(
      this.rawDevice.device_type,
      this.rawDevice.device_sn,
    );
  }
  ...
  public isLockWifiT8510P(): boolean {
    return Device.isLockWifiT8510P(
      this.rawDevice.device_type,
      this.rawDevice.device_sn,
    );
  }
  ...
  public isLockWifiT8520P(): boolean {
    return Device.isLockWifiT8520P(
      this.rawDevice.device_type,
      this.rawDevice.device_sn,
    );
  }
  ...
  public async setParameters(
    ...
    return this.api.setParameters(
      this.rawDevice.station_sn,
      this.rawDevice.device_sn,
      params,
    );
  }
...
export class Camera extends Device {
  ...
  public async startDetection(): Promise<void> {
    ...
    await this.setParameters([
      { paramType: ParamType.DETECT_SWITCH, paramValue: 1 },
    ]).catch((err) => {
      const error = ensureError(err);
      rootHTTPLogger.error("Camera start detection - Error", {
        error: getError(error),
        deviceSN: this.getSerial(),
      });
    });
  ...
  public async stopDetection(): Promise<void> {
    ...
    await this.setParameters([
      { paramType: ParamType.DETECT_SWITCH, paramValue: 0 },
    ]);
  }
  ...
  public processPushNotification(
    ...
    if (message.type !== undefined && message.event_type !== undefined) {
      if (
        message.event_type === CusPushEvent.SECURITY &&
        message.device_sn === this.getSerial()
      ) {
        try {
          loadEventImage(
            station,
          ...
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `Camera process push notification - CusPushEvent.SECURITY - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
        ...
        if (message.device_sn === this.getSerial()) {
          try {
            ...
            const error = ensureError(err);
            rootHTTPLogger.debug(
              `Camera process push notification - HB3PairedDevicePushEvent - Error`,
              {
                error: getError(error),
                deviceSN: this.getSerial(),
                message: JSON.stringify(message),
      ...
      if (message.device_sn === this.getSerial()) {
        try {
          ...
          switch (message.event_type) {
            ...
            default:
              rootHTTPLogger.debug(
                "SoloCamera process push notification - Unhandled solo camera push event",
                message,
              );
              break;
          }
    ...
    if (
      ...
      if (message.device_sn === this.getSerial()) {
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `IndoorCamera process push notification - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              message: JSON.stringify(message),
      ...
      if (message.device_sn === this.getSerial()) {
        try {
          ...
          switch (message.event_type) {
            ...
            default:
              rootHTTPLogger.debug(
                "DoorbellCamera process push notification - Unhandled doorbell push event",
                message,
              );
              break;
          }
          ...
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `DoorbellCamera process push notification - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              message: JSON.stringify(message),
    ...
    if (
      ...
      if (message.device_sn === this.getSerial()) {
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `FloodlightCamera process push notification - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              message: JSON.stringify(message),
    ...
    if (message.type !== undefined && message.event_type !== undefined) {
      if (message.device_sn === this.getSerial()) {
        try {
          ...
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `WallLightCam process push notification - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              message: JSON.stringify(message),
          ...
          if (value != undefined) {
            ...
            if (status >= 0) {
              if (property.name === PropertyName.DeviceDoor1Open) {
                return (
                  (status & GarageDoorState.A_OPENED) ===
                  GarageDoorState.A_OPENED
                );
              } else if (property.name === PropertyName.DeviceDoor2Open) {
                return (
                  (status & GarageDoorState.B_OPENED) ===
                  GarageDoorState.B_OPENED
                );
              }
            }
          }
        ...
        case CommandType.CMD_CAMERA_GARAGE_DOOR_SENSORS:
          if (value != undefined) {
            ...
            if (property.name === PropertyName.DeviceDoorSensor1BatteryLevel) {
              if (
                sensorsData?.data?.door_1?.power !== undefined &&
                sensorsData?.data?.door_1?.power > 1
              ) {
                this.updateProperty(
              ...
              return sensorsData?.data?.door_1?.power !== undefined
                ? sensorsData?.data?.door_1?.power
                : 0;
            } else if (
              property.name === PropertyName.DeviceDoorSensor2BatteryLevel
            ) {
              if (
                sensorsData?.data?.door_2?.power !== undefined &&
                sensorsData?.data?.door_2?.power > 1
              ) {
                this.updateProperty(
                  PropertyName.DeviceDoorSensor1LowBattery,
                  false,
              ...
              return sensorsData?.data?.door_2?.power !== undefined
                ? sensorsData?.data?.door_2?.power
                : 0;
            } else if (
              property.name === PropertyName.DeviceDoorSensor1MacAddress
            ) {
              return sensorsData?.data?.door_1?.mac_address !== undefined
                ? sensorsData?.data?.door_1?.mac_address
                : "";
            } else if (
              property.name === PropertyName.DeviceDoorSensor2MacAddress
            ) {
              return sensorsData?.data?.door_2?.mac_address !== undefined
                ? sensorsData?.data?.door_2?.mac_address
                : "";
            } else if (property.name === PropertyName.DeviceDoorSensor1Name) {
              return sensorsData?.data?.door_1?.name !== undefined
                ? sensorsData?.data?.door_1?.name
                : "";
            } else if (property.name === PropertyName.DeviceDoorSensor2Name) {
              return sensorsData?.data?.door_2?.name !== undefined
                ? sensorsData?.data?.door_2?.name
                : "";
            } else if (
              property.name === PropertyName.DeviceDoorSensor1SerialNumber
            ) {
              return sensorsData?.data?.door_1?.sn !== undefined
                ? sensorsData?.data?.door_1?.sn
                : "";
            } else if (
              property.name === PropertyName.DeviceDoorSensor2SerialNumber
            ) {
              return sensorsData?.data?.door_2?.sn !== undefined
                ? sensorsData?.data?.door_2?.sn
                : "";
            } else if (
              property.name === PropertyName.DeviceDoorSensor1Version
            ) {
              return sensorsData?.data?.door_1?.version !== undefined
                ? sensorsData?.data?.door_1?.version
                : "";
            } else if (
              property.name === PropertyName.DeviceDoorSensor2Version
            ) {
              return sensorsData?.data?.door_2?.version !== undefined
                ? sensorsData?.data?.door_2?.version
                : "";
            } else if (
              property.name === PropertyName.DeviceDoorControlWarning
            ) {
      ...
      if (message.device_sn === this.getSerial()) {
        try {
          ...
          switch (message.event_type) {
            ...
            default:
              rootHTTPLogger.debug(
                "GarageCamera process push notification - Unhandled GarageDoor push event",
                message,
              );
              break;
          }
          ...
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `GarageCamera process push notification - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              message: JSON.stringify(message),
...
export class EntrySensor extends Sensor {
  ...
  public processPushNotification(
    ...
    if (message.type !== undefined && message.event_type !== undefined) {
      if (
        message.event_type === CusPushEvent.DOOR_SENSOR &&
        message.device_sn === this.getSerial()
      ) {
        try {
          if (message.sensor_open !== undefined) {
            this.updateRawProperty(
              CommandType.CMD_ENTRY_SENSOR_STATUS,
              message.sensor_open ? "1" : "0",
              "push",
            );
          }
        } catch (err) {
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `EntrySensor process push notification - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              message: JSON.stringify(message),
  ...
  protected handlePropertyChange(
    ...
    super.handlePropertyChange(metadata, oldValue, newValue);
    if (
      metadata.name === PropertyName.DeviceSensorOpen &&
      metadata.key === CommandType.CMD_ENTRY_SENSOR_STATUS
    ) {
...
export class MotionSensor extends Sensor {
  ...
  public processPushNotification(
    ...
    if (message.type !== undefined && message.event_type !== undefined) {
      if (
        message.event_type === CusPushEvent.MOTION_SENSOR_PIR &&
        message.device_sn === this.getSerial()
      ) {
        try {
          this.updateProperty(PropertyName.DeviceMotionDetected, true);
          ...
          const error = ensureError(err);
          rootHTTPLogger.debug(
            `MotionSensor process push notification - Error`,
            {
              error: getError(error),
              deviceSN: this.getSerial(),
              message: JSON.stringify(message),
...
export class Lock extends Device {
  ...
  protected handlePropertyChange(
    ...
    if (metadata.name === PropertyName.DeviceLocked) {
      ...
      this.updateProperty(
        PropertyName.DeviceLocked,
        newValue === 4 ? true : false,
      );
    }
  }
  ...
  public static encodeESLCmdOnOff(
    ...
    const buf3 = Buffer.from([
      ESLAnkerBleConstant.b,
      1,
      lock === true ? 1 : 0,
      ESLAnkerBleConstant.c,
      4,
    ]);
  ...
  public processMQTTNotification(
  ...
  public static encodeCmdAddTemporaryUser(
    schedule?: Schedule,
    unlimited = false,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdModifyPassword(
    password_id: string,
    passcode: string,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdUpdateSchedule(
    short_user_id: string,
    schedule: Schedule,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdModifyUsername(
    username: string,
    password_id: string,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdSetLockParamAutoLock(
    enabled: boolean,
  ...
  public static encodeCmdSetLockParamAutoLockSchedule(
    ...
    const payload = new WritePayload();
    payload.write(
      this.getUint16BEBuffer(CommandType.CMD_SMARTLOCK_AUTO_LOCK_SCHEDULE),
    );
    payload.write(this.getUInt8Buffer(enabled === true ? 1 : 0));
  ...
  public static encodeCmdSetLockParamOneTouchLock(enabled: boolean): Buffer {
    const payload = new WritePayload();
    payload.write(
      this.getUint16BEBuffer(CommandType.CMD_SMARTLOCK_ONE_TOUCH_LOCK),
    );
    payload.write(this.getUInt8Buffer(enabled === true ? 1 : 0));
    payload.write(this.getCurrentTimeInSeconds());
    return payload.getData();
  ...
  public static encodeCmdSetLockParamWrongTryProtect(
    enabled: boolean,
    lockdownTime: number,
    attempts: number,
  ): Buffer {
    const payload = new WritePayload();
    payload.write(
      this.getUint16BEBuffer(CommandType.CMD_SMARTLOCK_WRONG_TRY_PROTECT),
    );
    payload.write(this.getUInt8Buffer(enabled === true ? 1 : 0));
  ...
  public static encodeCmdSetLockParamScramblePasscode(
    enabled: boolean,
  ): Buffer {
    const payload = new WritePayload();
    payload.write(
      this.getUint16BEBuffer(CommandType.CMD_SMARTLOCK_SCRAMBLE_PASSCODE),
    );
    payload.write(this.getUInt8Buffer(enabled === true ? 1 : 0));
    payload.write(this.getCurrentTimeInSeconds());
    return payload.getData();
        ...
        case CommandType.CMD_DOORLOCK_SET_PUSH_MODE:
          if (property.name === PropertyName.DeviceNotification) {
            ...
            return value !== undefined
              ? isSmartLockNotification(
                  Number.parseInt(value),
                  SmartLockNotification.LOCKED,
                )
              : false;
          } else if (
            property.name === PropertyName.DeviceNotificationUnlocked
          ) {
            return value !== undefined
              ? isSmartLockNotification(
                  Number.parseInt(value),
                  SmartLockNotification.UNLOCKED,
                )
              : false;
          }
          break;
  ...
  public static encodeCmdSetSmartLockParamOneTouchLock(
    adminUserId: string,
    enabled: boolean,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdSetSmartLockParamScramblePasscode(
    adminUserId: string,
    enabled: boolean,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdSetSmartLockParamSound(
    adminUserId: string,
    value: number,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdSmartLockDeleteUser(
    adminUserId: string,
    shortUserId: string,
  ): Buffer {
    const payload = new WritePayload();
  ...
  public static encodeCmdSmartLockModifyPassword(
    adminUserId: string,
    passwordId: string,
    passcode: string,
  ): Buffer {
...
export class SmartSafe extends Device {
  ...
  public static encodeCmdLeftOpenAlarm(
    user_id: string,
    enabled: boolean,
    duration: number,
  ): Buffer {
  ...
  public static encodeCmdScramblePIN(
    user_id: string,
    enabled: boolean,
  ): Buffer {
    return SmartSafe.encodeCmdSingleUInt8(user_id, enabled === true ? 1 : 0);
  ...
  public static encodeCmdInteriorBrightness(
    user_id: string,
  ...
  public static encodeCmdPushNotification(
    user_id: string,
    modes: number,
  ): Buffer {
    const payload = new WritePayload();
  ...
  protected convertRawPropertyValue(
    ...
    try {
      if (property.key === CommandType.CMD_SMARTSAFE_REMOTE_OPEN_TYPE) {
        ...
        return value !== undefined
          ? ((Number.parseInt(value) >>
              SmartSafe.PUSH_NOTIFICATION_POSITION[property.name]) &
              1) ===
              1
          : booleanProperty.default !== undefined
            ? booleanProperty.default
        ...
        try {
          switch (message.event_type) {
            ...
            case SmartSafeEvent.LOCK_STATUS: {
              const eventValues =
                message.event_value as SmartSafeEventValueDetail;
  ...
  protected handlePropertyChange(
    ...
    super.handlePropertyChange(metadata, oldValue, newValue);
    if (
      metadata.name === PropertyName.DeviceLocked &&
      metadata.key === CommandType.CMD_SMARTSAFE_LOCK_STATUS
    ) {
      this.emit("locked", this, newValue as boolean);
...
export class Tracker extends Device {
  ...
  public async setLeftBehindAlarm(value: boolean): Promise<boolean> {
    try {
      const property = this.getPropertyMetadata(
        ...
        switch (message.event_type) {
          ...
          case LockPushEvent.TEMPORARY_PW_LOCK: {
            ...
            if (!isEmpty(message.person_name)) {
              ...
              this.updateProperty(
                PropertyName.DeviceLockEventOrigin,
                getLockEventType(message.event_type),
              );
              this.clearEventTimeout(DeviceEvent.Lock);
              this.eventTimeouts.set(
                DeviceEvent.Lock,
          ...
          default:
            rootHTTPLogger.debug(
              "DoorbellLock process push notification - Unhandled lock notification event",
              {
          ...
          if (message.event_type === CusPushEvent.SMART_DROP) {
            switch (message.open) {
              case SmartDropOpen.OPEN:
                // Open
                this.updateRawProperty(
                  CommandType.CMD_SMART_DROP_OPEN,
                  "1",
                  "push",
                );
            ...
            rootHTTPLogger.debug(
              "SmartDrop process push notification - Unhandled SmartDrop push event type",
              message,
            );
          }
        } catch (err) {
