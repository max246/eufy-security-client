...
export const DeviceDeliveryGuardPackageGuardingActivatedTimeFromProperty: PropertyMetadataString =
  {
    ...
    label:
      "Delivery Guard Package Guarding Activated Time From (24-hour clock)",
    readable: true,
    writeable: true,
    type: "string",
    default: "00:00",
...
export const DeviceDeliveryGuardUncollectedPackageAlertTimeToCheckProperty: PropertyMetadataString =
  {
    ...
    label:
      "Delivery Guard Uncollected Package Alert Time To Check (24-hour clock)",
    readable: true,
    writeable: true,
    type: "string",
    default: "20:00",
...
export const FloodlightT8420XDeviceProperties: IndexedProperty = {
  ...
  [PropertyName.DeviceMotionDetectionSensitivity]:
    DeviceMotionDetectionSensitivityIndoorProperty,
  ...
  [PropertyName.DeviceAudioRecording]:
    DeviceAudioRecordingIndoorSoloFloodlightProperty,
  [PropertyName.DeviceMotionDetectionType]:
    DeviceMotionDetectionTypeFloodlightProperty,
  [PropertyName.DeviceRecordingClipLength]:
    DeviceRecordingClipLengthFloodlightProperty,
  [PropertyName.DeviceRecordingRetriggerInterval]:
    DeviceRecordingRetriggerIntervalFloodlightProperty,
  ...
  [PropertyName.DeviceNotificationType]:
    DeviceNotificationTypeIndoorFloodlightProperty,
...
export const WiredDoorbellT8200XDeviceProperties: IndexedProperty = {
  ...
  [PropertyName.DeviceAudioRecording]:
    DeviceAudioRecordingIndoorSoloFloodlightProperty,
  [PropertyName.DeviceMotionDetectionType]:
    DeviceMotionDetectionTypeT8200XProperty,
  [PropertyName.DeviceMotionDetectionSensitivity]:
    DeviceMotionDetectionSensitivityBatteryDoorbellProperty,
  [PropertyName.DeviceVideoStreamingQuality]:
    DeviceVideoStreamingQualitySoloProperty,
  ...
  [PropertyName.DeviceNotificationMotion]:
    DeviceNotificationMotionWiredDoorbellProperty,
  [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
  [PropertyName.DeviceSnoozeTime]: DeviceSnoozeTimeProperty,
  [PropertyName.DeviceSnoozeStartTime]: DeviceSnoozeStartTimeProperty,
  ...
  [PropertyName.DeviceVideoRecordingQuality]:
    DeviceVideoRecordingQualityT8200XProperty,
...
export const LockT8510PDeviceProperties: IndexedProperty = {
  ...
  [PropertyName.DeviceAutoLockScheduleEndTime]:
    DeviceAutoLockScheduleEndTimeProperty,
  ...
  [PropertyName.DeviceNotificationUnlocked]:
    DeviceNotificationUnlockedSmartLockProperty,
...
export const DeviceProperties: Properties = {
  ...
  [DeviceType.CAMERA2C]: {
    ...
    [PropertyName.DeviceNotificationType]: DeviceNotificationTypeProperty,
    [PropertyName.DeviceLightSettingsBrightnessManual]:
      DeviceCameraLightSettingsBrightnessManualProperty,
    [PropertyName.DeviceLight]: DeviceFloodlightLightProperty,
    [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
    [PropertyName.DeviceSnoozeTime]: DeviceSnoozeTimeProperty,
    [PropertyName.DeviceSnoozeStartTime]: DeviceSnoozeStartTimeProperty,
  ...
  [DeviceType.CAMERA2C_PRO]: {
    ...
    [PropertyName.DeviceNotificationType]: DeviceNotificationTypeProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityCameraProperty,
    [PropertyName.DeviceVideoRecordingQuality]:
      DeviceVideoRecordingQualityCamera2CProProperty,
    [PropertyName.DeviceLightSettingsBrightnessManual]:
      DeviceCameraLightSettingsBrightnessManualProperty,
    [PropertyName.DeviceLight]: DeviceFloodlightLightProperty,
    [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
  ...
  [DeviceType.CAMERA3]: {
    ...
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityCamera3Property,
    [PropertyName.DeviceVideoRecordingQuality]:
      DeviceVideoRecordingQualityCamera3Property,
    [PropertyName.DeviceLightSettingsEnable]:
      DeviceFloodlightLightSettingsEnableProperty,
    [PropertyName.DeviceLightSettingsBrightnessManual]:
      DeviceLightSettingsBrightnessManualCamera3Property,
    [PropertyName.DeviceLight]: DeviceFloodlightLightProperty,
  },
  [DeviceType.CAMERA3C]: {
    ...GenericDeviceProperties,
  ...
  [DeviceType.PROFESSIONAL_247]: {
    ...
    [PropertyName.DevicePersonName]: DevicePersonNameProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityCameraProfessionalProperty,
    [PropertyName.DeviceLightSettingsBrightnessManual]:
      DeviceLightSettingsBrightnessManualCamera3Property,
    [PropertyName.DeviceLight]: DeviceFloodlightLightProperty,
  ...
  [DeviceType.CAMERA]: {
    ...
    [PropertyName.DeviceAutoNightvision]: DeviceAutoNightvisionProperty,
    [PropertyName.DeviceMotionDetection]: DeviceMotionDetectionProperty,
    [PropertyName.DeviceWatermark]:
      DeviceWatermarkBatteryDoorbellCamera1Property,
    [PropertyName.DeviceMotionDetected]: DeviceMotionDetectedProperty,
    [PropertyName.DevicePicture]: DevicePictureProperty,
    [PropertyName.DevicePictureUrl]: DevicePictureUrlProperty,
    [PropertyName.DeviceMicrophone]: DeviceMicrophoneProperty,
    ...
    [PropertyName.DeviceRTSPStreamUrl]: DeviceRTSPStreamUrlProperty,
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivityCamera1Property,
    [PropertyName.DeviceMotionDetectionType]:
      DeviceMotionDetectionCamera1Property,
    [PropertyName.DeviceBattery]: DeviceBatteryProperty,
    [PropertyName.DeviceBatteryTemp]: DeviceBatteryTempProperty,
    [PropertyName.DeviceWifiRSSI]: DeviceWifiRSSIProperty,
    [PropertyName.DeviceWifiSignalLevel]: DeviceWifiSignalLevelProperty,
  ...
  [DeviceType.DOORBELL]: {
    ...
    [PropertyName.DeviceHiddenMotionDetectionMode]:
      DeviceHiddenMotionDetectionModeWiredDoorbellProperty,
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivityWiredDoorbellProperty,
    [PropertyName.DeviceVideoHDR]: DeviceVideoHDRWiredDoorbellProperty,
    [PropertyName.DeviceVideoDistortionCorrection]:
      DeviceVideoDistortionCorrectionWiredDoorbellProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityProperty,
    [PropertyName.DeviceVideoRecordingQuality]:
      DeviceVideoRecordingQualityWiredDoorbellProperty,
    [PropertyName.DeviceVideoRingRecord]:
      DeviceVideoRingRecordWiredDoorbellProperty,
    [PropertyName.DeviceAudioRecording]:
      DeviceAudioRecordingWiredDoorbellProperty,
    [PropertyName.DeviceChimeIndoor]: DeviceChimeIndoorWiredDoorbellProperty,
    [PropertyName.DeviceSpeakerVolume]:
      DeviceSpeakerVolumeWiredDoorbellProperty,
    ...
    [PropertyName.DeviceNotificationMotion]:
      DeviceNotificationMotionWiredDoorbellProperty,
    [PropertyName.DeviceNotificationType]:
      DeviceNotificationTypeWiredDoorbellProperty,
    [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
    [PropertyName.DeviceSnoozeTime]: DeviceSnoozeTimeProperty,
  ...
  [DeviceType.BATTERY_DOORBELL]: {
    ...
    [PropertyName.DevicePowerWorkingMode]:
      DevicePowerWorkingModeBatteryDoorbellProperty,
    [PropertyName.DeviceChargingStatus]: DeviceChargingStatusProperty,
    [PropertyName.DeviceRecordingClipLength]: DeviceRecordingClipLengthProperty,
    [PropertyName.DeviceRecordingRetriggerInterval]:
      DeviceRecordingRetriggerIntervalBatteryDoorbellProperty,
    [PropertyName.DeviceRecordingEndClipMotionStops]:
      DeviceRecordingEndClipMotionStopsProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityBatteryDoorbellProperty,
    ...
    [PropertyName.DeviceNotificationType]:
      DeviceNotificationTypeBatteryDoorbellProperty,
  ...
  [DeviceType.BATTERY_DOORBELL_PLUS]: {
    ...
    [PropertyName.DeviceDeliveryGuardPackageGuarding]:
      DeviceDeliveryGuardPackageGuardingProperty,
    ...
    [PropertyName.DeviceDeliveryGuardPackageLiveCheckAssistance]:
      DeviceDeliveryGuardPackageLiveCheckAssistanceProperty,
    [PropertyName.DeviceDeliveryGuardUncollectedPackageAlert]:
      DeviceDeliveryGuardUncollectedPackageAlertProperty,
  ...
  [DeviceType.BATTERY_DOORBELL_C30]: {
    ...
    [PropertyName.DeviceMotionDetectionType]: DeviceMotionDetectionTypeProperty,
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivityDoorbellE340Property,
    [PropertyName.DevicePowerWorkingMode]:
      DevicePowerWorkingModeBatteryDoorbellProperty,
    [PropertyName.DeviceChargingStatus]: DeviceChargingStatusProperty,
    [PropertyName.DeviceRecordingClipLength]: DeviceRecordingClipLengthProperty,
  ...
  [DeviceType.BATTERY_DOORBELL_PLUS_E340]: {
    ...
    [PropertyName.DeviceDeliveryGuardUncollectedPackageAlertTimeToCheck]:
      DeviceDeliveryGuardUncollectedPackageAlertTimeToCheckProperty,
    [PropertyName.DeviceDualCamWatchViewMode]:
      DeviceDualCamWatchViewModeE340Property,
    [PropertyName.DeviceRingAutoResponse]: DeviceRingAutoResponseProperty,
    [PropertyName.DeviceRingAutoResponseVoiceResponse]:
      DeviceRingAutoResponseVoiceResponseProperty,
    [PropertyName.DeviceRingAutoResponseVoiceResponseVoice]:
  ...
  [DeviceType.LOCK_8530]: {
    ...
    [PropertyName.DeviceWatermark]:
      DeviceWatermarkBatteryDoorbellCamera1Property, //OK
    [PropertyName.DeviceState]: DeviceStateProperty,
    [PropertyName.DeviceLastChargingDays]: DeviceLastChargingDaysProperty,
    [PropertyName.DeviceLastChargingFalseEvents]:
      DeviceLastChargingFalseEventsProperty,
    ...
    [PropertyName.DevicePictureUrl]: DevicePictureUrlProperty,
    [PropertyName.DeviceSpeakerVolume]:
      DeviceSpeakerVolumeIndoorFloodDoorbellProperty, //OK
    [PropertyName.DeviceRingtoneVolume]:
      DeviceRingtoneVolumeBatteryDoorbellProperty, //OK
    [PropertyName.DeviceAudioRecording]: DeviceAudioRecordingProperty,
    ...
    [PropertyName.DeviceRecordingEndClipMotionStops]:
      DeviceRecordingEndClipMotionStopsProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityBatteryDoorbellProperty, //OK
    [PropertyName.DeviceVideoRecordingQuality]:
      DeviceVideoRecordingQualityT8530Property, //OK
    [PropertyName.DeviceChimeIndoor]: DeviceChimeIndoorBatteryDoorbellProperty,
    [PropertyName.DeviceChimeHomebase]:
      DeviceChimeHomebaseBatteryDoorbellProperty, //OK
    [PropertyName.DeviceChimeHomebaseRingtoneVolume]:
      DeviceChimeHomebaseRingtoneVolumeBatteryDoorbellProperty, //OK
    [PropertyName.DeviceChimeHomebaseRingtoneType]:
      DeviceChimeHomebaseRingtoneTypeBatteryDoorbellProperty, //OK
    [PropertyName.DeviceNotificationType]:
      DeviceNotificationTypeBatteryDoorbellProperty, //OK
    ...
    [PropertyName.DeviceLeavingReactionNotification]:
      DeviceLeavingReactionNotificationProperty,
    [PropertyName.DeviceLeavingReactionStartTime]:
      DeviceLeavingReactionStartTimeProperty,
    [PropertyName.DeviceLeavingReactionEndTime]:
      DeviceLeavingReactionEndTimeProperty,
    ...
    [PropertyName.DeviceNightvisionOptimization]:
      DeviceNightvisionOptimizationProperty,
    [PropertyName.DeviceNightvisionOptimizationSide]:
      DeviceNightvisionOptimizationSideProperty,
  },
  [DeviceType.FLOODLIGHT]: {
    ...
    [PropertyName.DeviceSpeaker]: DeviceSpeakerProperty,
    [PropertyName.DeviceSpeakerVolume]:
      DeviceSpeakerVolumeFloodlightT8420Property,
    [PropertyName.DeviceAudioRecording]:
      DeviceAudioRecordingFloodlightT8420Property,
    [PropertyName.DeviceRecordingClipLength]:
      DeviceRecordingClipLengthFloodlightProperty,
    [PropertyName.DeviceRecordingRetriggerInterval]:
      DeviceRecordingRetriggerIntervalFloodlightProperty,
  ...
  [DeviceType.FLOODLIGHT_CAMERA_8423]: {
    ...
    [PropertyName.DeviceAudioRecording]: DeviceAudioRecordingProperty,
    [PropertyName.DeviceMotionDetectionType]:
      DeviceMotionDetectionTypeFloodlightT8423Property,
    [PropertyName.DeviceRecordingClipLength]:
      DeviceRecordingClipLengthFloodlightProperty,
    [PropertyName.DeviceRecordingEndClipMotionStops]:
      DeviceRecordingEndClipMotionStopsProperty,
  ...
  [DeviceType.FLOODLIGHT_CAMERA_8425]: {
    ...
    [PropertyName.DeviceLightSettingsBrightnessManual]:
      DeviceFloodlightLightSettingsBrightnessManualProperty,
    [PropertyName.DeviceLightSettingsBrightnessMotion]:
      DeviceFloodlightLightSettingsBrightnessMotionT8425Property,
    [PropertyName.DeviceLightSettingsBrightnessSchedule]:
      DeviceFloodlightLightSettingsBrightnessScheduleT8425Property,
    [PropertyName.DeviceLightSettingsMotionTriggered]:
      DeviceFloodlightLightSettingsMotionTriggeredT8425Property,
    [PropertyName.DeviceLightSettingsMotionTriggeredTimer]:
    ...
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivityBatteryDoorbellProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityS340Property,
    [PropertyName.DeviceVideoRecordingQuality]:
      DeviceVideoRecordingQualityS340Property,
    [PropertyName.DeviceMotionTracking]: DeviceMotionTrackingProperty,
    [PropertyName.DeviceMotionDetectionRange]:
      DeviceMotionDetectionRangeT8425Property,
    [PropertyName.DeviceMotionDetectionRangeStandardSensitivity]:
    ...
    [PropertyName.DeviceMotionDetectionTestMode]:
      DeviceMotionDetectionTestModeT8425Property,
    [PropertyName.DeviceMotionAutoCruise]: DeviceMotionAutoCruiseProperty,
    [PropertyName.DeviceMotionOutOfViewDetection]:
      DeviceMotionOutOfViewDetectionProperty,
    [PropertyName.DeviceLightSettingsMotionActivationMode]:
      DeviceLightSettingsMotionActivationModeT8425Property,
    [PropertyName.DeviceAutoCalibration]: DeviceAutoCalibrationProperty,
    [PropertyName.DeviceWifiRSSI]: DeviceWifiRSSIProperty,
    [PropertyName.DeviceWifiSignalLevel]: DeviceWifiSignalLevelProperty,
    [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
    ...
    [PropertyName.DeviceDualCamWatchViewMode]:
      DeviceDualCamWatchViewModeS340Property,
    [PropertyName.DeviceImageMirrored]: DeviceImageMirroredProperty,
  ...
  [DeviceType.INDOOR_CAMERA]: {
    ...
    [PropertyName.DeviceSoundDetectionSensitivity]:
      DeviceSoundDetectionSensitivityProperty,
    ...
    [PropertyName.DeviceNotificationAllSound]:
      DeviceNotificationAllSoundProperty,
  ...
  [DeviceType.INDOOR_COST_DOWN_CAMERA]: {
    ...
    [PropertyName.DeviceAudioRecording]:
      DeviceAudioRecordingIndoorSoloFloodlightProperty,
    [PropertyName.DeviceMotionDetectionType]:
      DeviceMotionDetectionTypeIndoorMiniProperty,
    [PropertyName.DeviceMotionTracking]: DeviceMotionTrackingProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityProperty,
    [PropertyName.DeviceVideoRecordingQuality]:
    ...
    [PropertyName.DeviceDefaultAngleIdleTime]:
      DeviceDefaultAngleIdleTimeProperty,
    [PropertyName.DeviceNotificationIntervalTime]:
      DeviceNotificationIntervalTimeProperty,
    [PropertyName.DeviceSoundDetectionRoundLook]:
      DeviceSoundDetectionRoundLookProperty,
    [PropertyName.DeviceVideoTypeStoreToNAS]: DeviceVideoTypeStoreToNASProperty,
    [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
    [PropertyName.DeviceSnoozeTime]: DeviceSnoozeTimeProperty,
    [PropertyName.DeviceSnoozeStartTime]: DeviceSnoozeStartTimeProperty,
  ...
  [DeviceType.OUTDOOR_PT_CAMERA]: {
    ...
    [PropertyName.DevicePictureUrl]: DevicePictureUrlProperty,
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivitySoloProperty,
    [PropertyName.DeviceMicrophone]: DeviceMicrophoneProperty,
    [PropertyName.DeviceSpeaker]: DeviceSpeakerProperty,
    [PropertyName.DeviceSpeakerVolume]:
      DeviceSpeakerVolumeIndoorFloodDoorbellProperty,
    ...
    [PropertyName.DeviceChargingStatus]: DeviceChargingStatusProperty,
    [PropertyName.DeviceRecordingClipLength]:
      DeviceRecordingClipLengthOutdoorPTProperty,
    [PropertyName.DeviceRecordingRetriggerInterval]:
      DeviceRecordingRetriggerIntervalProperty,
    [PropertyName.DeviceRecordingEndClipMotionStops]:
      DeviceRecordingEndClipMotionStopsProperty,
  ...
  [DeviceType.INDOOR_PT_CAMERA_S350]: {
    ...
    [PropertyName.DeviceSoundDetectionType]:
      DeviceSoundDetectionTypeS350Property,
    [PropertyName.DeviceSoundDetectionSensitivity]:
      DeviceSoundDetectionSensitivityProperty,
    [PropertyName.DeviceCryingDetected]: DeviceCryingDetectedProperty,
    [PropertyName.DeviceStatusLed]: DeviceStatusLedIndoorFloodProperty,
    ...
    [PropertyName.DeviceMotionDetectionTypeAllOtherMotions]:
      DeviceMotionHB3DetectionTypeAllOtherMotionsProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualityS350Property,
    [PropertyName.DeviceVideoRecordingQuality]:
    ...
    [PropertyName.DeviceNotificationAllOtherMotion]:
      DeviceNotificationAllOtherMotionS350Property,
    [PropertyName.DeviceNotificationAllSound]:
      DeviceNotificationAllSoundS350Property,
    [PropertyName.DeviceNotificationCrying]:
      DeviceNotificationCryingS350Property,
    [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
    [PropertyName.DeviceSnoozeTime]: DeviceSnoozeTimeProperty,
    [PropertyName.DeviceSnoozeStartTime]: DeviceSnoozeStartTimeProperty,
    [PropertyName.DevicePersonName]: DevicePersonNameProperty,
    [PropertyName.DeviceMotionTracking]: DeviceMotionTrackingProperty,
    [PropertyName.DeviceSoundDetectionRoundLook]:
      DeviceSoundDetectionRoundLookS350Property,
    [PropertyName.DeviceRotationSpeed]: DeviceRotationSpeedProperty,
    [PropertyName.DeviceMotionAutoCruise]: DeviceMotionAutoCruiseProperty,
    [PropertyName.DeviceAutoCalibration]: DeviceAutoCalibrationProperty,
    [PropertyName.DeviceDualCamWatchViewMode]:
  ...
  [DeviceType.CAMERA_FG]: {
    ...
    [PropertyName.DeviceAudioRecording]:
      DeviceAudioRecordingStarlight4gLTEProperty,
    [PropertyName.DeviceMotionDetectionType]: DeviceMotionDetectionTypeProperty,
    [PropertyName.DevicePowerWorkingMode]: DevicePowerWorkingModeProperty,
    [PropertyName.DeviceRecordingClipLength]: DeviceRecordingClipLengthProperty,
    [PropertyName.DeviceRecordingRetriggerInterval]:
  ...
  [DeviceType.SOLO_CAMERA_SOLAR]: {
    ...
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualitySoloProperty,
    [PropertyName.DeviceVideoRecordingQuality]:
      DeviceVideoRecordingQualitySoloProperty,
    [PropertyName.DeviceWifiRSSI]: DeviceWifiRSSIProperty,
    [PropertyName.DeviceWifiSignalLevel]: DeviceWifiSignalLevelProperty,
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivitySoloProperty,
  ...
  [DeviceType.KEYPAD]: {
    ...
    [PropertyName.DeviceBatteryIsCharging]:
      DeviceBatteryIsChargingKeypadProperty,
  },
  ...
  [DeviceType.MOTION_SENSOR]: {
    ...
    [PropertyName.DeviceMotionSensorPIREvent]:
      DeviceMotionSensorPIREventProperty,
  },
  [DeviceType.SENSOR]: {
    ...GenericDeviceProperties,
  ...
  [DeviceType.SMART_SAFE_7400]: {
    ...
    [PropertyName.DeviceWrongTryProtection]:
      DeviceWrongTryProtectionSmartSafeProperty,
    [PropertyName.DeviceWrongTryAttempts]:
      DeviceWrongTryAttemptsSmartSafeProperty,
    [PropertyName.DeviceWrongTryLockdownTime]:
      DeviceWrongTryLockdownTimeSmartSafeProperty,
    [PropertyName.DeviceLeftOpenAlarm]: DeviceLeftOpenAlarmProperty,
    [PropertyName.DeviceLeftOpenAlarmDuration]:
      DeviceLeftOpenAlarmDurationProperty,
    ...
    [PropertyName.DeviceInteriorBrightnessDuration]:
      DeviceInteriorBrightnessDurationProperty,
    ...
    [PropertyName.DeviceRemoteUnlockMasterPIN]:
      DeviceRemoteUnlockMasterPINProperty,
    [PropertyName.DeviceScramblePasscode]:
      DeviceScramblePasscodeSmartSafeProperty,
    ...
    [PropertyName.DeviceNotificationUnlockByKey]:
      DeviceNotificationUnlockByKeyProperty,
    [PropertyName.DeviceNotificationUnlockByPIN]:
      DeviceNotificationUnlockByPINProperty,
    [PropertyName.DeviceNotificationUnlockByFingerprint]:
      DeviceNotificationUnlockByFingerprintProperty,
    [PropertyName.DeviceNotificationUnlockByApp]:
      DeviceNotificationUnlockByAppProperty,
    [PropertyName.DeviceNotificationDualLock]:
      DeviceNotificationDualLockProperty,
    [PropertyName.DeviceNotificationDualUnlock]:
      DeviceNotificationDualUnlockProperty,
    [PropertyName.DeviceNotificationWrongTryProtect]:
      DeviceNotificationWrongTryProtectProperty,
    ...
    [PropertyName.DeviceLongTimeNotCloseAlert]:
      DeviceLongTimeNotCloseAlertProperty,
    [PropertyName.DeviceWrongTryProtectAlert]:
      DeviceWrongTryProtectAlertProperty,
  },
  ...
  [DeviceType.SMART_DROP]: {
    ...
    [PropertyName.DeviceMotionActivatedPrompt]:
      DeviceMotionActivatedPromptProperty,
    [PropertyName.DeviceAutoNightvision]: DeviceAutoNightvisionProperty,
    ...
    [PropertyName.DeviceHighTemperatureAlert]:
      DeviceHighTemperatureAlertProperty,
    ...
    [PropertyName.DeviceMicrophone]: DeviceMicrophoneProperty,
    [PropertyName.DeviceRecordingClipLength]:
      DeviceRecordingClipLengthWalllightProperty,
    [PropertyName.DeviceRecordingEndClipMotionStops]:
      DeviceRecordingEndClipMotionStopsProperty,
    [PropertyName.DeviceWifiRSSI]: DeviceWifiRSSIProperty,
    [PropertyName.DevicePersonName]: DevicePersonNameProperty,
    [PropertyName.DeviceVideoStreamingQuality]:
      DeviceVideoStreamingQualitySmartDropProperty,
  ...
  [DeviceType.WALL_LIGHT_CAM]: {
    ...
    [PropertyName.DeviceVideoRecordingQuality]:
      DeviceVideoRecordingQualityWalllightProperty,
    [PropertyName.DeviceNotificationPerson]:
      DeviceNotificationPersonWalllightProperty,
    [PropertyName.DeviceNotificationAllOtherMotion]:
      DeviceNotificationAllOtherMotionWalllightProperty,
    [PropertyName.DeviceMotionDetectionTypeHuman]:
      DeviceMotionDetectionTypeHumanWallLightProperty,
    [PropertyName.DeviceMotionDetectionTypeAllOtherMotions]:
      DeviceMotionDetectionTypeAllOtherMotionsWalllightProperty,
    [PropertyName.DeviceNotification]: DeviceNotificationWalllightProperty,
    [PropertyName.DeviceNotificationType]:
      DeviceNotificationTypeWalllightProperty,
  },
  [DeviceType.WALL_LIGHT_CAM_81A0]: {
    ...
    [PropertyName.DeviceLight]: DeviceFloodlightLightProperty,
    [PropertyName.DeviceLightSettingsBrightnessManual]:
      DeviceCameraLightSettingsBrightnessManualWalllightS120Property,
    [PropertyName.DeviceLightSettingsMotionTriggered]:
      DeviceFloodlightLightSettingsMotionTriggeredProperty,
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivityBatteryDoorbellProperty,
    ...
    [PropertyName.DeviceAudioRecording]: DeviceAudioRecordingProperty,
    [PropertyName.DeviceRecordingClipLength]:
      DeviceRecordingClipLengthWalllightS120Property,
    [PropertyName.DeviceRecordingEndClipMotionStops]:
      DeviceRecordingEndClipMotionStopsProperty,
    [PropertyName.DeviceRecordingRetriggerInterval]:
      DeviceRecordingRetriggerIntervalProperty,
  ...
  [DeviceType.CAMERA_GARAGE_T8453]: {
    ...
    [PropertyName.DeviceWifiSignalLevel]: DeviceWifiSignalLevelProperty,
    [PropertyName.DeviceMotionDetectionSensitivity]:
      DeviceMotionDetectionSensitivityGarageCameraProperty,
    [PropertyName.DeviceState]: DeviceStateProperty,
    [PropertyName.DeviceSnooze]: DeviceSnoozeProperty,
    [PropertyName.DeviceSnoozeTime]: DeviceSnoozeTimeProperty,
    [PropertyName.DeviceSnoozeStartTime]: DeviceSnoozeStartTimeProperty,
    ...
    [PropertyName.DeviceDoorSensor1SerialNumber]:
      DeviceDoorSensor1SerialNumberProperty,
    ...
    [PropertyName.DeviceDoorSensor2LowBattery]:
      DeviceDoorSensor2LowBatteryProperty,
    [PropertyName.DeviceRTSPStream]: DeviceRTSPStreamProperty,
    [PropertyName.DeviceRTSPStreamUrl]: DeviceRTSPStreamUrlProperty,
    [PropertyName.DeviceVideoTypeStoreToNAS]: DeviceVideoTypeStoreToNASProperty,
  },
...
export const StationProperties: Properties = {
  [DeviceType.STATION]: {
    ...
    [PropertyName.StationNotificationSwitchModeGeofence]:
      StationNotificationSwitchModeGeofenceProperty,
    ...
    [PropertyName.StationNotificationSwitchModeKeypad]:
      StationNotificationSwitchModeKeypadProperty,
  ...
  [DeviceType.HB3]: {
    ...
    [PropertyName.StationCrossCameraTracking]:
      StationCrossCameraTrackingProperty,
    [PropertyName.StationContinuousTrackingTime]:
      StationContinuousTrackingTimeProperty,
    [PropertyName.StationTrackingAssistance]: StationTrackingAssistanceProperty,
    [PropertyName.StationCrossTrackingCameraList]:
      StationCrossTrackingCameraListProperty,
    [PropertyName.StationCrossTrackingGroupList]:
      StationCrossTrackingGroupListProperty,
  },
